...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-16 md:pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-20">
        <div className="max-w-3xl mx-auto text-center space-y-6 md:space-y-8">
          <p className="font-body text-[10px] sm:text-xs tracking-[0.3em] sm:tracking-[0.4em] text-muted-foreground uppercase opacity-0 animate-fade-in animation-delay-100">
            Premium Essentials
          </p>
          ...
          <div className="opacity-0 animate-fade-in animation-delay-400">
            <button
              ...
              className="inline-flex items-center justify-center px-8 sm:px-12 py-3.5 sm:py-4 border border-foreground text-foreground font-body text-xs sm:text-sm tracking-[0.15em] sm:tracking-[0.2em] uppercase hover:bg-foreground hover:text-background transition-all duration-300 active:scale-[0.98] touch-manipulation"
            >
              Shop Now
            </button>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 opacity-0 animate-fade-in animation-delay-500">
        <button
          onClick={scrollToShop}
          className="flex flex-col items-center gap-2 text-muted-foreground hover:text-foreground transition-colors touch-manipulation"
