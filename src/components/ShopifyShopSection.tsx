...
const ShopifyShopSection = () => {
  ...
  if (loading) {
    return <section id="shop" className="min-h-screen py-24 sm:py-32 bg-background flex items-center justify-center">
  ...
  return <section id="shop" className="min-h-screen py-20 sm:py-28 md:py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-sm sm:max-w-md mx-auto">
          {products.map((product, index) => <ShopifyProductCard key={product.node.id} product={product} index={index} />)}
        </div>
      </div>
    </section>;
};
